...
- 📋 **14 条协作规则**：精确约束 AI 的语言风格、输出规范、反驳义务、范围管理和对话边界
- 🔄 **规则迭代闭环**：观察 → 诊断 → 立法 → 验证，规则在真实对话中不断进化
- 📝 **公开输出**：已将踩坑经验写成技术文章，发布在 CSDN、掘金和知乎

## 📂 文件说明

| 文件 | 作用 |
| :--- | :--- |
| `项目规则书 & 通用协作规则.md` | 14 条协作规则 v2.5（身份、日志规范、输出约束、范围管理、反驳义务等） |
